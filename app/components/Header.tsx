export default function PricingSection() {
  return (
    ...
    <nav className="hidden gap-8 text-sm md:flex">
        ...
        <a href="/#booking" className="underline-offset-4 underline decoration-transparent transition-colors duration-200 hover:underline hover:decoration-current">Pricing</a>
    </nav>
